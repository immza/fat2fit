    ...
    <div class="container">
        ...
        <div class="product">
            ...
            <div class="info">
                ...
                <button class="add-to-cart" onclick="addToCart(20)">Add to Cart</button>
            </div>
        </div>
        <div class="product">
            ...
            <div class="info">
                ...
                <button class="add-to-cart" onclick="addToCart(25)">Add to Cart</button>
            </div>
        </div>
        ...
        <a href='/payment'><button onclick="proceedToDelivery()">Proceed to Payment</button></a>
    </div>
