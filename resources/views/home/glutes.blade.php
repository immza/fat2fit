...
<head>
    ...
    <title>20 Minutes Ab Workout</title>
</head>
<style>
    body {
        margin: 0;
    ...
    .background-image {
        background-image: url('images/GlutesBg.webp');
...
<body>
    <div class="background-image">
        <div class="exercise-container">
            <h1>20 Minutes Glutes Workout</h1>
            <div class="exercise">
        ...
        const exercises = [
            {
                ...
                image: 'images/GlutesSquats.webp'
            },
            {
                name:'Break Time',
